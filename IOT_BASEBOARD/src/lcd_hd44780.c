...
//	
//	GPIO_ResetBits(GPIOC, GPIO_Pin_15);	//RW LOW
//}
...
void TM_HD44780_InitPins(void) {
  ...
  /* Set pins low */
  HAL_GPIO_WritePin(TM_HD44780_RS_PORT, TM_HD44780_RS_PIN, GPIO_PIN_RESET);
  HAL_GPIO_WritePin(TM_HD44780_E_PORT,  TM_HD44780_E_PIN, GPIO_PIN_RESET);
  HAL_GPIO_WritePin(TM_HD44780_D4_PORT, TM_HD44780_D4_PIN, GPIO_PIN_RESET);
  HAL_GPIO_WritePin(TM_HD44780_D5_PORT, TM_HD44780_D5_PIN, GPIO_PIN_RESET);
  HAL_GPIO_WritePin(TM_HD44780_D6_PORT, TM_HD44780_D6_PIN, GPIO_PIN_RESET);
  HAL_GPIO_WritePin(TM_HD44780_D7_PORT, TM_HD44780_D7_PIN, GPIO_PIN_RESET);
}
...
void TM_HD44780_Cmd4bit(uint8_t cmd) {
  ...
  if((cmd & 0x08) == 0x08) 
    HAL_GPIO_WritePin(TM_HD44780_D7_PORT, TM_HD44780_D7_PIN, GPIO_PIN_SET); 
  else 
    HAL_GPIO_WritePin(TM_HD44780_D7_PORT, TM_HD44780_D7_PIN, GPIO_PIN_RESET);
  
  if((cmd & 0x04) == 0x04) 
    HAL_GPIO_WritePin(TM_HD44780_D6_PORT, TM_HD44780_D6_PIN, GPIO_PIN_SET); 
  else 
    HAL_GPIO_WritePin(TM_HD44780_D6_PORT, TM_HD44780_D6_PIN, GPIO_PIN_RESET);
  
  if((cmd & 0x02) == 0x02) 
    HAL_GPIO_WritePin(TM_HD44780_D5_PORT, TM_HD44780_D5_PIN, GPIO_PIN_SET); 
  else 
    HAL_GPIO_WritePin(TM_HD44780_D5_PORT, TM_HD44780_D5_PIN, GPIO_PIN_RESET);
  
  if((cmd & 0x01) == 0x01) 
    HAL_GPIO_WritePin(TM_HD44780_D4_PORT, TM_HD44780_D4_PIN, GPIO_PIN_SET); 
  else 
    HAL_GPIO_WritePin(TM_HD44780_D4_PORT, TM_HD44780_D4_PIN, GPIO_PIN_RESET);
...
void TM_HD44780_Puts_State(uint8_t x, uint8_t y, char* str) {
  ...
  if((Setting_enable == 0) && (cDisplayEnable == RESET)){
    cDisplayEnable = SET;
    TM_HD44780_CursorSet(x, y);
    while (*str) {
      if (TM_HD44780_Opts.currentX >= TM_HD44780_Opts.Cols) {
