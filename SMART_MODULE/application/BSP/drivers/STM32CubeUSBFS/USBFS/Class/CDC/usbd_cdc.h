...
#define CDC_DATA_HS_IN_PACKET_SIZE                  USB_HS_MAX_PACKET_SIZE
#define CDC_DATA_HS_OUT_PACKET_SIZE                 USB_HS_MAX_PACKET_SIZE

#define CDC_DATA_FS_IN_PACKET_SIZE                  USB_FS_MAX_PACKET_SIZE/4
#define CDC_DATA_FS_OUT_PACKET_SIZE                 USB_FS_MAX_PACKET_SIZE/4
...
{
	uint8_t *Buffer;
	int16_t _s; 	//Buffer array size
	int16_t _r;		//Read pointer
	int16_t _w; 	//Write pointer
