...
{
	TM_HD44780_Puts(0,0,"Dawoon 20170328");
...
extern uint16_t start_delay_time;
...
void basic_mode(void)
{
	...
	TM_HD44780_Puts(0,1, "2016.11.10");	//>로라통신 
	TM_HD44780_Puts(10,1, " A:OOO"); //>고유번호
}
